...
class UpdateViewController: NSViewController {
  ...
  override func viewWillAppear() {
    NotificationCenter.default.addObserver(self,
                                           selector: #selector(macModelsUpdateComplete(notification:)),
                                           name: macModelsUpdateComplete,
                                           object: nil)
    NotificationCenter.default.addObserver(self,
                                           selector: #selector(bootCampPackagesUpdateComplete(notification:)),
                                           name: bootCampPackagesUpdateComplete,
                                           object: nil)
    self.update()
  }
