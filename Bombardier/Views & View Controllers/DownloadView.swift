...
class DownloadView: NSView {
  ...
  let darkAppearanceFillColor = NSColor(calibratedRed: 10.0/255.0,
                                        green: 132.0/255.0,
                                        blue: 255.0/255.0,
                                        alpha: 1.0)
  let lightApearanceFillColor = NSColor(calibratedRed: 0.0/255.0,
                                        green: 122.0/255.0,
                                        blue: 255.0/255.0,
                                        alpha: 1.0)
  ...
  override func draw(_ dirtyRect: NSRect) {
    ...
    let fillColor = self.inDarkMode ? darkAppearanceFillColor : lightApearanceFillColor
    fillColor.setStroke()
